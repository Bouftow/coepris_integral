<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="lcis.aspx.cs" Inherits="_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMenus" runat="Server">
    ...
    <%=Usuarios.ShowMenu(User.Identity.Name,String.Format("cis.default.-1"),this.Page) %>
    <%=UsuariosOS.ShowMenu(User.Identity.Name,String.Format("cis.default.-1"),this.Page) %>
</asp:Content>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                <div class="header-block">
                    <h3>Centro Integral de Servicios</h3>
                </div>
                 
                <ul class="nav nav-tabs pull-right" role="tablist">
                   
                    <li class="nav-item"><a class="nav-link active" href="#Recibidos" role="tab" data-toggle="tab"> <span runat="server" id="contadorCIS"></span></a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Notificar" role="tab" data-toggle="tab"><span runat="server" id="contadorCIScor"></span></a> </li>
                    <li class="nav-item"><a class="nav-link" href="#History" role="tab" data-toggle="tab">Capturados</a> </li>
                </ul>
...
<%--                                                    <button type="submit" class="Editar"
                                                        onclick='javascript:location.href = ("EditarBitacora.aspx?id=<%# Eval("folio") %>")'>
                                                        Editar</button>--%>

                                                    <button type="submit" class="Editar"
                                                        onclick='javascript:location.href = ("lAcuse.aspx?id=<%# Eval("folio") %>")'>
                                                        Acuse</button>
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Notificar">
                        ...
                        <label>Notificar/Entregar </label>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField >
                                                <ItemTemplate>
                                                      ...
                                                      <button type="submit" class="Editar"
                                                        onclick='javascript:location.href = ("CIS.aspx?id=<%# Eval("folio") %>")'>
                                                        Ver Datos</button>
