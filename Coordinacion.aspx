<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Coordinacion.aspx.cs" Inherits="_default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
  ...
  <%--  <script type="text/javascript">
    ...
    <div class="card-block card">
        <div class="card sameheight-item" data-exclude="xs">   <h3>Coordinación Jurisdiccional</h3>
        ...
        <div class="card-block">
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active fade show" id="Requisitos">
                    ...
                    <div id="or" runat="server">
                       <%-- <div id="Eval1" runat="server" class="grid-container">


                            <div id="1" class="grid-item" style="text-align: center">
                                <div class="input-group" id="div14">
                                    <a>• </a>
                                    <label runat="server" id="lbl31">Evaluación Documental.</label>
                                </div>
                            </div>
                            <div id="2" class="grid-item" style="text-align: center">
                        ...
                        <div id="idacta" runat="server">
                            <h2 style="text-align: center">Acta de Verificación.</h2>
                            <div id="grido" class="grid-container">
                        ...
                        <div id="idDicTec" runat="server">
                            <h2 style="text-align: center">Dictamen Técnico.</h2>
        ...
        <div style="text-align: center">
            ...
            <div class="btn-group div1">
                <asp:Button ID="btnAprobado27"
                    OnClick="btnAprobado_Click"
                    runat="server" class="myButtonAprobar"
                    Text="Recibir desde Correspondencia" />
                <asp:Literal ID="Literal2" runat="server"></asp:Literal>
            </div>

            <div class="btn-group div1">
                <asp:Button ID="btnAprobado28"
                    OnClick="btnAprobado_Click"
                    runat="server" class="myButtonAprobar"
                    Text="Enviar al CIS" />
