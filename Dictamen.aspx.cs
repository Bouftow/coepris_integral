...
public partial class _default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (statos.Text == "6" || statos.Text == "13")
                {
                ...
                if (riesgo.Text == "1")
                {
                    if (statos.Text == "6")
                    {
                        ...
                        if (chkVerificacion.Checked == false) { sino.InnerText = "No"; sdivacta.Visible = false; sdict.Visible=false; grid2.Visible = false; }
                    }
                }
    ...
    protected void btnGuardarDatos_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            { Response.Redirect("ldictaminador.aspx"); }
        }
        catch (Exception Ex)
        {
            LblMsg.Text = Ex.Message;
