<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="loficom.aspx.cs" Inherits="_default" %>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                   <button type="submit" class="Editar" 
                                                        onclick='javascript:location.href = ("oficom.aspx?id=<%# Eval("folio") %>")'>
                                                        Ver Datos</button>
                                                </ItemTemplate>
                                            </asp:TemplateField>
