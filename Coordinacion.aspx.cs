...
public partial class _default : System.Web.UI.Page
{
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                if (riesgo.Text == "1")
                {
                    ...
                    btnAprobado5.Text = "Enviar a la UOS";

                    if (statos.Text == "2" || statos.Text == "7" || statos.Text == "26" || statos.Text == "27" || statos.Text=="14" || statos.Text =="35")
                    {
                        if (statos.Text == "2")
                        {

                            btnAprobado5.Visible = true;
                            btnAprobado27.Visible = false;
                            btnAprobado28.Visible = false;
                            btnAprobado10.Visible = false;
                            btnGuardar.Visible = false;
                            idacta.Visible = false;
                            idDicTec.Visible = false;


                        }
                        if (statos.Text == "7" || statos.Text=="35")
                        {
                            ...
                            btnAprobado10.Visible = false;
                            btnGuardar.Visible = false;
                            btnAprobado5.Text = "Enviar a DEAS";
                        ...
                        if (statos.Text == "26")
                        {
                            ...
                            btnAprobado5.Visible = false;
                            btnAprobado27.Visible = true;
                            btnAprobado28.Visible = false;
                            btnAprobado10.Visible = false;
                            btnGuardar.Visible = false;
                        }
                    ...
                    if (riesgo.Text == "2")
                    {
                        ...
                        switch (statos.Text.ToString())
                        {
                            case "1002":
                                ...
                                btnAprobado10.Visible = false;
                                btnGuardar.Visible = false;
                                btnAprobado5.Text = "Enviar a la DEAS";
                                or.Visible = false; 
                                break;
                            ...
                            case "1010":
                                ...
                                btnAprobado10.Visible = false;
                                btnGuardar.Visible = false;
                                btnAprobado5.Text = "Enviar al DOS";
                                idDicTec.Visible = false;
                                break;
                            ...
                            case "1023":
                                ...
                                btnAprobado10.Visible = false;
                                btnGuardar.Visible = false;
                                btnAprobado5.Text = "Enviar al CIS";
                                or.Visible = true;
                                break;
                ...
                if (riesgo.Text == "1")
                {
                    if (statos.Text == "7" || statos.Text == "2")
                    {
                        chkVerificacion.Checked = tramite.RequiereVerificacion;
                        if (chkVerificacion.Checked == true) { sino.InnerText = "Sí"; }
                        if (chkVerificacion.Checked == false) { sino.InnerText = "No"; idacta.Visible = false; idDicTec.Visible = false; }
    ...
    protected void btnAprobado_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            { Response.Redirect("lcoordinacion.aspx"); }
        }
        catch (Exception Ex)
        {
            LblMsg.Text = Ex.Message;
