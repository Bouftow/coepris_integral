<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="luos.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                <div class="header-block">
                    <h3>Unidad de Operación Sanitaria</h3>
                </div>
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Recibidos" role="tab" data-toggle="tab"><span runat="server" id="contadorUOS"></span></a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Evaluados" role="tab" data-toggle="tab">Verificados</a> </li>
            ...
            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="Recibidos">
                        ...
                        <label>Pendientes de Verificar </label>
                        <div class="row estil ">
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                   ...
                                                   <button type="submit" class="Editar" 
                                                        onclick='javascript:location.href = ("UOS.aspx?id=<%# Eval("folio") %>")'>
                                                        Evaluar</button>
