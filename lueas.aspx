...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMenus" runat="Server">
    <%=Usuarios.ShowMenu(User.Identity.Name,String.Format("ueas.default.-1"),this.Page) %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist" style="width:60%">
                    <li class="nav-item"><a runat="server" id="recibidos" class="nav-link active" href="#Recibidos" role="tab" data-toggle="tab"><span runat="server" id="contadorUEAS"></span></a> </li>
                                   ...
                                   <%-- <asp:Repeater ID="Repeater1" runat="server">
                                    ...
                                    <asp:GridView ID="grdUEAS"
                                        ...
                                        <Columns>
                                            ...
                                            <%--<asp:BoundField HeaderText="Riesgo" DataField="Nombre_tipo_riesgo" ItemStyle-Wrap="false" />--%>
