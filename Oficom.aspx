<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Oficom.aspx.cs" Inherits="_default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="card-block card">
        <div class="card sameheight-item" data-exclude="xs">  <h3>Oficina del Comisionado</h3>
        ...
        <div style="text-align: center">
            ...
            <div class="btn-group div1">
                <asp:Button ID="btnAprobado26"
                    OnClick="btnAprobado_Click"
                    runat="server" class="myButton"
                    Text="Firmado y Enviado a Correspondencia" />
