...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="col-sm-12">
        <button id="btnPDF" clientidmode="Static" class="btn btn-secondary" onserverclick="btnPDF_ServerClick" runat="server"><i class="fa fa-download"></i>&nbsp;Descargar Comprobante</button>
    </div>
    ...
    <div class="col-sm-12">
        <div style="text-align: center;" class="alert alert-primary header-block" runat="server">
            ...
            <p style="font-family: HelveticaNeueLTStd-Lt; font-size: 18px; color: white; text-align: center">Recuerda cumplir con tus responsabilidades como institución educativa</p>
