<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="lcaptura.aspx.cs" Inherits="_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMenus" runat="Server">
    ...
    <%=Usuarios.ShowMenu(User.Identity.Name,String.Format("captura.default.-1"),this.Page) %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
                    ...
                    <div class="row">
                        <div class="col-sm-4 offset-sm-4">
                            <asp:DropDownList ID="ddlCategorias" AutoPostBack="true"
                                ...
                                OnSelectedIndexChanged="ddlCategorias_SelectedIndexChanged" CssClass="CentrarSelect" Width="100%">
                            </asp:DropDownList>
                        </div>
                        <div class="col-sm-12">
                            ...
                            <asp:DropDownList ID="ddlTramites" runat="server"
                                ...
                                AutoPostBack="true"
                                OnSelectedIndexChanged="ddlTramites_SelectedIndexChanged" CssClass="CentrarSelect" Width="100%">
                            </asp:DropDownList>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-header card-header-sm bordered" style="text-align: center">
                ...
                <ul class="nav nav-tabs" role="tablist" id="myTab">
                    ...
                    <%--<li class="nav-item" id="r"><a class="nav-link" href="#ResponsableSanitario" role="tab" data-toggle="tab">Datos del Responsable Sanitario</a> </li>--%>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group col-sm-12">
                                  ...
                                  <%--      <div class="col-sm-4">
                                            <label>CURP:</label>
                                            <asp:TextBox ID="txtCurp" class="form-control b" Style="text-transform: uppercase;"
                                                runat="server" oninput="validarInput(this)" onclick="validarInput(this)"
                                                onkeypress="return curpValida(event)" onchange="validarInput(this)"
                                                MaxLength="18" MinLength="18" autocomplete="true"></asp:TextBox>
                                          
                                            <ajaxToolkit:AutoCompleteExtender ServiceMethod="BuscarCURP"
                                                MinimumPrefixLength="2"
                                                CompletionListCssClass="completionList"
                                                CompletionListHighlightedItemCssClass="itemHighlighted"
                                                CompletionListItemCssClass="listItem"
                                                CompletionInterval="100" EnableCaching="false" CompletionSetCount="10"
                                                TargetControlID="txtCurp" OnClientItemSelected="GetID"
                                                ID="AutoCompleteExtender2" runat="server" FirstRowSelected="false">
                                            </ajaxToolkit:AutoCompleteExtender>
                                            <script>
                                                function GetID(source, eventArgs) {
                                                    var HdnKey = eventArgs.get_value();
                                                    //document.getElementById('<%=txtCurp.ClientID %>').value = HdnKey;
                                                    //alert(HdnKey)
                                                }
                                            </script>
                                            <p id="resultado"></p>
                                ...
                                <asp:TextBox ID="txtNombre" class="form-control css-input"
                                    ...
                                    Style="text-transform: uppercase;"></asp:TextBox>
                                            ...
                                            <asp:CustomValidator runat="server"
                                                ...
                                                OnServerValidate="Nombre_ServerValidate"
                                                ClientValidationFunction="ValidarNombreSol"></asp:CustomValidator>
                                        </div>
                                        <div class="col-sm-4">
                                            Apellido Paterno:
                                 <asp:TextBox ID="txtApellidop" class="form-control css-input"
                                     ...
                                     Style="text-transform: uppercase;"></asp:TextBox>
                                            ...
                                            <asp:CustomValidator runat="server"
                                                ...
                                                ValidateEmptyText="true"
                                                SetFocusOnError="true"
                                                OnServerValidate="Apellidop_ServerValidate"
                                                ClientValidationFunction="ValidarApellidop"></asp:CustomValidator>
                                        </div>
                                        <div class="col-sm-4">
                                            Apellido Materno:
                                 <asp:TextBox ID="txtApellidom" class="form-control css-input"
                                     ...
                                     Style="text-transform: uppercase;"></asp:TextBox>
                                            ...
                                            <asp:CustomValidator runat="server"
                                                ...
                                                ForeColor="Red"
                                                ValidateEmptyText="true"
                                                OnServerValidate="Apellidom_ServerValidate"
                                                ClientValidationFunction="ValidarApellidom"></asp:CustomValidator>
                                        </div>
                                    </div>
                              ...
                              <asp:TextBox Width="120px" ID="txtTelmov" MaxLength="10" MinLength="10" class="form-control css-input" runat="server"
                                  onkeypress="return numbersonly(event)" autocomplete=""></asp:TextBox>
                                            ...
                                            <asp:CustomValidator runat="server"
                                                ID="CFVTelmov"
                                                ControlToValidate="txtTelmov"
                                                ErrorMessage="Favor de colocar un teléfono válido(10 dígitos)."
                                                SetFocusOnError="true"
                                                ForeColor="Red"
                                                ValidateEmptyText="true"
                                                OnServerValidate="Telmov_ServerValidate"
                                                ClientValidationFunction="ValidarTelmov"></asp:CustomValidator>
                                        </div>
                                        <div class="col-sm-3">
                                ...
                                <asp:TextBox Width="120px" ID="txtTelfij" SetFocusOnError="true" MaxLength="10" MinLength="10" class="form-control css-input" runat="server" onkeypress="return numbersonly(event)" autocomplete=""></asp:TextBox>
                                            ...
                                            <asp:CustomValidator runat="server"
                                                ID="CFVTelfij"
                                                ControlToValidate="txtTelfij"
                                                ErrorMessage="Favor de colocar un teléfono válido(10 dígitos) o dejar en blanco."
                                                SetFocusOnError="true"
                                                ForeColor="Red" ValidateEmptyText="false"
                                                OnServerValidate="Telfij_ServerValidate"
                                                ClientValidationFunction="ValidarTelfij"></asp:CustomValidator>
                                        </div>
                                    </div>
                                    <div style="width: 100%" class="row">
                                        <div class="col-sm-5">
                                            <label>
                                                ...
                                                <asp:CustomValidator runat="server"
                                                    ...
                                                    ClientValidationFunction="ValidarCorreo"></asp:CustomValidator>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-8">
                                                ...
                                                <label>
                                                    RFC:<br />
                                                    <asp:TextBox ID="txtRfc" class="form-control" Style="text-transform: uppercase"
                                                ...
                                                <asp:CustomValidator runat="server"
                                                    ...
                                                    ValidateEmptyText="true"
                                                    ForeColor="Red"
                                                    OnServerValidate="RFCest_ServerValidate"
                                                    ClientValidationFunction="ValidarRFCest"></asp:CustomValidator>
                                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server"
                                                    ControlToValidate=""
                                                    ErrorMessage="Se necesita del RFC."
                                                    ForeColor="Red">
                                            ...
                                            <div class="col-sm-11">
                                                <div>
                                                    ...
                                                    <asp:CustomValidator runat="server"
                                                        ...
                                                        SetFocusOnError="true"
                                                        ForeColor="Red"
                                                        OnServerValidate="Nombreest_ServerValidate"
                                                        ValidateEmptyText="true"
                                                        ClientValidationFunction="ValidarNombreest"></asp:CustomValidator>
                                                </div>
                                              <%--  <div>
                                                ...
                                                <asp:TextBox TextMode="multiline" Rows="3" ID="txtRazonsocial" Style="text-transform: uppercase;" class="form-control css-input" runat="server"></asp:TextBox>
                                                    <asp:CustomValidator runat="server"
                                                        ...
                                                        SetFocusOnError="true"
                                                        ForeColor="Red"
                                                        OnServerValidate="Razonsocial_ServerValidate"
                                                        ValidateEmptyText="true"
                                                        ClientValidationFunction="ValidarRazonSocial"></asp:CustomValidator>
                                                </div>--%>
                                            </div>
                                        </div>
                                    </div>
...
<%--                        <label>Horario:</label><br />
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="LunesH1inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="LunesH1fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="LunesH2inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="LunesH2fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <button id="btnLunes" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input id="MartesH1inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="MartesH1fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="MartesH2inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="MartesH2fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <button id="btnMartes" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input id="MiercolesH1inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="MiercolesH1fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="MiercolesH2inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="MiercolesH2fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <button id="btnMiercoles" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input id="JuevesH1inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="JuevesH1fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="JuevesH2inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="JuevesH2fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <button id="btnJueves" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="ViernesH1inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="ViernesH1fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="ViernesH2inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="ViernesH2fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <button id="btnViernes" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input id="SabadoH1inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="SabadoH1fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="SabadoH2inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="SabadoH2fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <button id="btnSabado" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input id="DomingoH1inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="DomingoH1fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="DomingoH2inicio" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                <td>
                                    <input id="DomingoH2fin" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                            </tr>
                        </table>--%>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group col-sm-12">
                                    <div class="row">
                                        <div class="col-sm-4 ">
                                            Nombre(s):
                                <asp:TextBox ID="txtRnombre" class="form-control css-input" runat="server" onkeypress="return sololetras(event)" Style="text-transform: uppercase;"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtRnombre" ErrorMessage="Campo requerido." ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>
                                       ...
                                       <div class="col-sm-5">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="LunesH1inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="LunesH1finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="LunesH2inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="LunesH2finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <button id="btnLunesR" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-right: hidden">Martes:</td>
                                                    ...
                                                    <td>
                                                        <input id="MartesH1inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="MartesH1finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="MartesH2inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="MartesH2finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <button id="btnMartesR" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-right: hidden">Miércoles:</td>
                                                    ...
                                                    <td>
                                                        <input id="MiercolesH1inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="MiercolesH1finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="MiercolesH2inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="MiercolesH2finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <button id="btnMiercolesR" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-right: hidden">Jueves:</td>
                                                    ...
                                                    <td>
                                                        <input id="JuevesH1inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="JuevesH1finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="JuevesH2inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="JuevesH2finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <button id="btnJuevesR" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input id="ViernesH1inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="ViernesH1finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="ViernesH2inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="ViernesH2finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <button id="btnViernesR" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-right: hidden">Sábado:</td>
                                                    ...
                                                    <td>
                                                        <input id="SabadoH1inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="SabadoH1finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="SabadoH2inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="SabadoH2finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <button id="btnSabadoR" causesvalidation="false" onclick="return false;"><i class="fa fa-arrow-down"></i></button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="border-right: hidden">Domingo:</td>
                                                    ...
                                                    <td>
                                                        <input id="DomingoH1inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="DomingoH1finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="DomingoH2inicioR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                    <td>
                                                        <input id="DomingoH2finR" runat="server" autopostback="true" type="text" class="timepicker timepickerHour" onkeypress="return numbersonly(event)" /></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
