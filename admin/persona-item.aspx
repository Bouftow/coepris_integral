...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMenus" Runat="Server">
    <%=Usuarios.ShowMenu(User.Identity.Name,String.Format("admin_persona_item.default.-1"),this.Page) %>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <asp:LinkButton ID="btnGrabar" OnClick="btnGrabar_Click"  CssClass="btn btn-primary" runat="server"><i class="fa fa-save"></i>&nbsp;Grabar</asp:LinkButton>
        </div>
    </div>
