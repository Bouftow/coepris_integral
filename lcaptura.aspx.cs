...
public partial class _default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Response.Write("<script>alert('"+usuarios.NumeroCoordinacion+"')</script>");

        //if (riesgo.Text == "1")
        //{
        //    txtRiesgo.Text = "Bajo Riesgo";
        //}
        //else { if (riesgo.Text == "2") { txtRiesgo.Text = "Alto Riesgo"; } }
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.Params["m"] != null) { ddlCategorias.SelectedValue = Request.Params["m"]; }
            if (Request.Params["t"] != null) {
                ...
                ddlTramites.SelectedValue = Request.Params["t"]; 
        ...
        if (IsPostBack)
        {
            ddlCategorias.Items[0].Enabled = false;
            ddlTramites.Items[0].Enabled = false;
    ...
    private void ModalidadTramitesDropDownList()
    {
        ...
        if (Request.Params["t"] == null) { ddlTramites.Enabled = false; }
    ...
    protected void ddlCategorias_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            parameter.ParameterName = "@modalidad";
            parameter.Value = ddlCategorias.SelectedValue;
            //Response.Write("<script>alert('"+ddlCategorias.SelectedValue.ToString()+"')</script>");
    ...
    protected void ddlTramites_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (p5 == "209" || p5=="210" || p5 == "211" || p5=="212") { Response.Redirect("Captura_Fumigacion.aspx?r="+p1+"&v="+p2+ "&m=" + p3+ "&c=" + p4+ "&t=" + p5); }
        //if (a == 1)
        //{
        //    txtRiesgo.Text = "Bajo Riesgo";
        //}
        ...
        //Response.Write("<script>alert('Número de requisitos " + numeroderequisitos.Text + "') </script>");
        ...
        //str.Append(" <table> ");
        //str.Append("  <tr> < th > Requisito </ th >< th style = \"text-align: center\" > Activo </ th ></ tr > ");


        //if (rq.SOLLICASN == true)
        //{
        //    str.Append("<tr>");
        //    str.Append("<td>SOLICITUD DE LICENCIA SANITARIA</></td>");
        //    str.Append(" <td style=\"text - align: center\">");
        //    str.Append(" <asp:CheckBox ID=\"chksollicsan\" runat=\"server\" />");
        //    str.Append("</td>");
        //    str.Append(" < td style = \"border - right: hidden; border - top: hidden; border - bottom: hidden; \" > ");
        //    str.Append("< asp:CustomValidator runat = \"server\" ID = \"CheckBoxRequired\" EnableClientScript = \"true\"");
        //    str.Append(" OnServerValidate = \"CheckBoxRequired_ServerValidate\" > Debes seleccionar este campo para continuar </ asp:CustomValidator >");
        //    str.Append("</ td >");
        //    str.Append("</ tr >");
        //    //str.Append("");
        //}
    ...
    protected void btnGuardarDatos_Click(object sender, EventArgs e)
    {
       if(Page.IsValid == true){
            ...
            string g = "1=00:00-00:00|2=00:00-00:00|3=00:00-00:00|4=00:00-00:00|5=00:00-00:00|6=00:00-00:00|7=00:00-00:00";
            ...
            string horario1 = "1=00:00-00:00|2=00:00-00:00|3=00:00-00:00|4=00:00-00:00|5=00:00-00:00|6=00:00-00:00|7=00:00-00:00";
            ...
            string horario2 = "1=00:00-00:00|2=00:00-00:00|3=00:00-00:00|4=00:00-00:00|5=00:00-00:00|6=00:00-00:00|7=00:00-00:00";
            ...
            string gR = "1=00:00-00:00|2=00:00-00:00|3=00:00-00:00|4=00:00-00:00|5=00:00-00:00|6=00:00-00:00|7=00:00-00:00";
            ...
            string horario1R = "1=00:00-00:00|2=00:00-00:00|3=00:00-00:00|4=00:00-00:00|5=00:00-00:00|6=00:00-00:00|7=00:00-00:00";
            ...
            string horario2R = "1=00:00-00:00|2=00:00-00:00|3=00:00-00:00|4=00:00-00:00|5=00:00-00:00|6=00:00-00:00|7=00:00-00:00";
            ...
            //{
                if (Page.IsValid)
                {
                    ...
                    try
                    {
                       ...
                       // OJO AQUI, SE GUARDA NOMBRE EST EN RAZON SOCIAL, PORQUE SE QUITÓ LA RAZÓN SOCIAL, AÚN APARECE EN PREVISUALIZAR DATOS EN CIS (AL FINAL DEL TRAMITE)
                    tramite.Razonsocial = txtNombreest.Text.ToUpper();
