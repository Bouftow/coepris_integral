<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="DEAS.aspx.cs" Inherits="_default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="card-block card">
        <div class="card sameheight-item" data-exclude="xs"><h3>Dirección de Evaluación y Autorización Sanitaria</h3>
        ...
        <div class="card-block">
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active fade show" id="Requisitos">
                    ...
                    <div runat="server" id="desaparecer">
                    <table id="verifica" runat="server">

                        <tr>
                            <th style="padding: 5px; border: dotted">No Necesita Verificación ni Dictamen Jurisdiccional</th>
                            <th style="padding: 20px; visibility: hidden;">
                                <asp:CheckBox ID="chkVerificacion" Enabled="false" runat="server" /></th>
                        </tr>
        ...
        <div style="text-align: center">
            ...
            <div class="btn-group div1">
                <asp:Button ID="btnAprobado24"
                    OnClick="btnAprobado_Click"
                    runat="server" class="myButton"
                    Text="Enviar a Oficina de Comisionado" />
