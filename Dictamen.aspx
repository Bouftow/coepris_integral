<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Dictamen.aspx.cs" Inherits="_default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="card-block card">
        <div class="card sameheight-item" data-exclude="xs"><h3>Dictamen</h3>
     ...
     <%-- <table style="width:100%">
                        ...
                        <tr runat="server" id="uno">
                            ...
                            <td class="sr" style="text-align: center"> <asp:CheckBox ID="chkSolLicSan" runat="server" Enabled="false" /></td>
                    ...
                    <div class="grid-container">
                        ...
                        <div class="grid-item">
                            <div class="input-group" id="div14">
                                <a>• </a><label runat="server" id="lbl31">Evaluación Documental.</label>
                            </div>
                        </div>
                        ...
                        <div id="gridacta" class="grid-container">
                            ...
                            <div class="grid-item">
                                <div class="input-group">
                                    <a>• </a><label runat="server" id="lbl32">Acta de Verificación.</label>
                                </div>
                            </div>
                            <div class="grid-item" style="text-align:center">
                                <div class="input-group-prepend">
                    ...
                    <div id="grid2" runat="server" class="grid-container">
                        ...
                        <div class="grid-item">
                            <div class="input-group">
                               ...
                               <a>• </a><label runat="server" id="lbl33">Dictamen Técnico.</label>
                            </div>
                        </div>
                        <div class="grid-item" style="text-align:center">
                            <div class="input-group-prepend">
  ...
  <br />
          ...
          <div style="text-align: center">
            ...
            <div style="padding-left:60px; padding-right:60px" class="btn-group div1">
