<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ldictaminador.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Recibidos" role="tab" data-toggle="tab"><span runat="server" id="contadorDIC"></span></a> </li>
                    <li class="nav-item"><a class="nav-link" href="#History" role="tab" data-toggle="tab">Evaluados</a> </li>
                </ul>
            </div>
            ...
            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="Recibidos">
                        ...
                        <label>Pendientes de Dictaminar </label>
                        <div class="row estil ">
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <button type="submit" class="Editar" 
                                                        onclick='javascript:location.href = ("Dictamen.aspx?id=<%# Eval("folio") %>")'>
                                                        Dictaminar</button>
