<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="lcis_sl.aspx.cs" Inherits="_default" %>
                                        ...
                                        <Columns>
                                              <asp:TemplateField >
                                                <ItemTemplate>
                                                      ...
                                                      <button type="submit" class="Editar"
                                                        onclick='javascript:location.href = ("CIS_sl.aspx?id=<%# Eval("folio") %>")'>
                                                        <a class="btn">Ver Datos</a></button>
