<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Reporteador_comedor.aspx.cs" Inherits="Reportes_Distintivos_Reporteador" %>
                ...
                <div class="card" runat="server">
                    <asp:Label ID="LblMsg" runat="server"></asp:Label>
                      <asp:UpdatePanel ID="up1" runat="server">
                            <ContentTemplate>
                                <asp:HiddenField runat="server" ID="nombre_ddl" />
                                <asp:HiddenField runat="server" ID="id_distintivo" />
                    <div class="row">
                                ...
                                <asp:GridView ID="GridView2"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="CustomerID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="id_comedor" runat="server" Text='<%#Eval("id_comedor") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField SortExpression="id_escuela" HeaderText="id_escuela" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="id_escuela" runat="server" Text='<%#Eval("id_escuela") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField SortExpression="folio" HeaderText="folio">
                                            <ItemTemplate>
                                                <asp:Label ID="folio" runat="server" Text='<%#Eval("folio") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField SortExpression="nombrecoordinacion" HeaderText="Coordinación">
                                            <ItemTemplate>
                                                <asp:Label ID="nombrecoordinacion" runat="server" Text='<%#Eval("nombrecoordinacion") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField SortExpression="Clave del Centro de Trabajo" HeaderText="claveCT" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="claveCT" runat="server" Text='<%#Eval("claveCT") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                     <%--   <asp:TemplateField SortExpression="id_estatus" ControlStyle-CssClass="custom-select CentrarSelect" HeaderText="Estatus">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField SortExpression="tipo_unidad_consumo" HeaderText="Unidad de Consumo" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="tipo_unidad_consumo" runat="server" Text='<%#Eval("tipo_unidad_consumo") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField SortExpression="nombre" HeaderText="Nombre de la Institución" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="nombre" runat="server" Text='<%#Eval("nombre") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField SortExpression="turno" HeaderText="Turno" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="turno" runat="server" Text='<%#Eval("turno") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField SortExpression="cp" HeaderText="Código Postal" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="cp" runat="server" Text='<%#Eval("cp") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField SortExpression="colonia" HeaderText="Colonia" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="colonia" runat="server" Text='<%#Eval("colonia") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField SortExpression="vialidad" HeaderText="Vialidad" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="vialidad" runat="server" Text='<%#Eval("vialidad") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField SortExpression="numext" HeaderText="Número exterior" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="numext" runat="server" Text='<%#Eval("numext") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField SortExpression="control" HeaderText="Control" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="control" runat="server" Text='<%#Eval("control") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField SortExpression="ambito" HeaderText="Ámbito" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="ambito" runat="server" Text='<%#Eval("ambito") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField SortExpression="tipo" HeaderText="tipo" ItemStyle-Wrap="false">
                                            <ItemTemplate>
