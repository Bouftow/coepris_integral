<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Reporteador.aspx.cs" Inherits="Reportes_Distintivos_Reporteador" %>
                                ...
                                <asp:GridView ID="GridView2"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="CustomerID" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="id_distintivo" runat="server" Text='<%#Eval("id_distintivo") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField SortExpression="giro" HeaderText="Giro" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="giro" runat="server" Text='<%#Eval("giro") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField SortExpression="nombreest" HeaderText="Nombre del establecimiento" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="nombreest" runat="server" Text='<%#Eval("nombreest") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                     ...
                                     <%--   <asp:TemplateField SortExpression="dias_laborales" HeaderText="Días laborales" ItemStyle-Wrap="false">
                                        ...
                                        <asp:TemplateField SortExpression="correo" HeaderText="Correo Electrónico" ItemStyle-Wrap="false">
                                          ...
                                          <asp:TemplateField SortExpression="medio_conocido" HeaderText="Medio por el cual se enteró" ItemStyle-Wrap="false">
                                            <ItemTemplate>
                                                <asp:Label ID="medio_conocido" runat="server" Text='<%#Eval("medio_conocido") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
