<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="CIS.aspx.cs" Inherits="_default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="card-block card">
        ...
        <div class="card-block"><asp:label ID="Label1" runat="server"></asp:label>
                    ...
                    <div class="form-group col-sm-12">
                      ...
                      <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 ">
                                Nombre(s):
                                <asp:TextBox ID="txtNombre" disabled="true" class="form-control css-input" runat="server" onkeypress="return sololetras(event)" ></asp:TextBox>
        ...
        <div style="text-align: center">
            ...
            <div class="btn-group div1">
                <asp:Button ID="btnAprobado30"
                    OnClick="btnPrevision_Click"
                    runat="server" class="myButton"
                    Text="Notificar al Usuario" />
                <asp:Literal ID="Literal" runat="server"></asp:Literal>
            </div>          
            <div class="btn-group div1">
                <asp:Button ID="btnAprobado31"
                    OnClick="btnAprobado_Click"
                    runat="server" class="myButtonAprobar"
                    Text="Entregar al Usuario" />
