<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="VerDatos.aspx.cs" Inherits="_default" %>
    ...
    <div class="card-block card">
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#DatosSol" role="tab" data-toggle="tab">Datos del Solicitante</a> </li>
        ...
        <div class="card-block">
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade active show" id="DatosSol">
