<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ldas.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                <div class="header-block">
                    <h3>Departamento de Autorización y Licencias Sanitarias</h3>
                </div>
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Recibidos" role="tab" data-toggle="tab"><span runat="server" id="contadorDAS"></span></a></li>
                    <li class="nav-item"><a class="nav-link" href="#Evaluados" role="tab" data-toggle="tab">Evaluados</a> </li>
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="grdDAS"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button class="Editar" ID="Button1" runat="server" CommandName="Select" CommandArgument="<%# Container.DataItemIndex %>"
                                                        Text='<%# ((int)Eval("id_statos") == 1004) ? "Evaluar" : "Recibir e Imprimir" %>' />

                                                    <button type="submit" class="Editar"
                                                        onclick='javascript:location.href = ("dals_rel.aspx?id=<%# Eval("folio") %>")'>
                                                        Ver Datos</button>
                                                </ItemTemplate>
                                    ...
                                    <asp:GridView ID="grdDASH"
                                        ...
                                        <Columns>
                                           <asp:TemplateField >
                                             ...
                                             <asp:BoundField HeaderText="" DataField="id_statos" ItemStyle-Wrap="false" ItemStyle-CssClass="hidden" HeaderStyle-CssClass="hidden"  />
                                          <asp:BoundField HeaderText="Folio" DataField="folioseguimiento" ItemStyle-Wrap="false" />
                                            <%--<asp:BoundField HeaderText="Riesgo" DataField="riesgo" ItemStyle-Wrap="false" />--%>
                                            <asp:BoundField HeaderText="Razón Social" DataField="razonsocial" ItemStyle-Wrap="false" />
