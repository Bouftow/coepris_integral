<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="DOS.aspx.cs" Inherits="_default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="Server">
    ...
    <div class="card-block card">
        <div class="card sameheight-item" data-exclude="xs">  <h3>Dirección de Operación Sanitaria</h3>
            ...
            <div class="tab-content">
             ...
             <%--           <table style="width:100%">
                    ...
                    <div id="grid" class="grid-container">
                        ...
                        <div class="grid-item">
                            <div class="input-group fr" id="div14">
                    ...
                    <div id="sdivacta">
                        ...
                        <div id="gridacta" class="grid-container" style="padding-top:15px">
                    ...
                    <h2 id="sdiv" style="text-align: center">Dictamen Técnico.</h2>
                    <div id="grid2" class="grid-container">
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphFooter" runat="Server">
    ...
    <script>
        ...
        if (statos == '1011' || statos == '1005') {
            ...
            if (statos != '1011') {
                $('#gridacta').addClass('z');
                $('#gridacta').removeClass('y');
                $('#sdivacta').addClass('z');
                $('#sdivacta').removeClass('y');
            }
