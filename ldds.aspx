<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="ldds.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                <div class="header-block">
                    <h3>Departamento de Dictamen Sanitario</h3>
                </div>
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Recibidos" role="tab" data-toggle="tab"><span runat="server" id="contadorDDS"></span></a></li>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <button type="submit" class="Editar"
                                                        onclick='javascript:location.href = ("DDS.aspx?id=<%# Eval("folio") %>")'>
                                                        Evaluar</button>
                                                </ItemTemplate>
