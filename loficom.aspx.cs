...
public partial class _default : System.Web.UI.Page
{
    ...
    void MostrarDatos()
    {
        ...
        cmd.CommandText = "select IIF (tramites.riesgo = 2,'Alto Riesgo','Bajo Riesgo' ) AS riesgo," +
            ...
            "where "+coord+" ((Estatus_Bajoalto.id_statos=1031 or Estatus_Bajoalto.id_statos=1032) or (Estatus_Bajoalto.id_statos=40 or Estatus_Bajoalto.id_statos=41)) " +
        ...
        cmd.CommandText = "Select IIF (tramites.riesgo = 2,'Alto Riesgo','Bajo Riesgo' ) AS riesgo," +
            ...
            "where "+coord+" (expStatusHistory.id_statos>=1031 and expStatusHistory.id_statos<=1032) " +
