<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="lcat.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                <div class="header-block">
                    <h3>Centro de Monitoreo y Atención a Usuarios</h3>
                </div>
                <ul class="nav nav-tabs pull-right" role="tablist">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#Evaluados" role="tab" data-toggle="tab">Finalizados</a> </li>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    ...
                                                    <button type="submit" class="Editar"
                                                        onclick='javascript:location.href = ("CAT.aspx?id=<%# Eval("folio") %>")'>
                                                        Ver Datos</button>
                                                </ItemTemplate>
