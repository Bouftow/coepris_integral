        ...
        <div class="card sameheight-item" data-exclude="xs">
            ...
            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade in" id="Generales"> <%--Datos Generales--%>
                        <br />
                        <div class="container">
                       ...
                       en su carácter de 
                        ...
                        <asp:TextBox  AutoPostBack="false" class="form-control-sm" ID="visted" runat="server" placeholder="Introducir Nombre..." ></asp:TextBox>    
                            , y se identifica con
                                    ...
                                    <table class="table table-hover" >
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            ...
                                                            2--%>
                                                            <asp:RadioButton GroupName="opt1" ID="RadioButton1" runat="server" Text="2" />
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <%--<input type="radio" class="form-check-input" name="optradio1" />
                                                            1--%>
                                                            <asp:RadioButton GroupName="opt1" ID="RadioButton2" runat="server" Text="1" />
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <%--<input type="radio" class="form-check-input" name="optradio1" />
                                                            0--%>
                                                            <asp:RadioButton GroupName="opt1" ID="RadioButton3" runat="server" Text="0" />
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <%--<input type="radio" class="form-check-input" name="optradio1"/>
                                                            N/A--%>
                                                            <asp:RadioButton GroupName="opt1" ID="RadioButton4" runat="server" Text="N/A" />
                                                        </label>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="bordered">
                                                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="myTable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio7" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio9" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio10" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio11" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio12" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                ...
                <dl>
                    ...
                    <dd style="padding-left: 20px;">- Soluciones antisépticas.</dd>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio13" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio14" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio15" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio16" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio17" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio18" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio19" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio20" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio21" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio22" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                      ...
                      <dl>
                          ...
                          <dd style="padding-left: 20px;">- Ropa estéril para atención del recién nacido (frazada, sabanita, campo doble y campo sencillo).</dd>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio23" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                       ...
                       <dl>
                           ...
                           <dd style="padding-left: 20px;">- Sistema para guarda de expedientes clí­nicos.</dd>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio24" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                        ...
                        <dl>
                            ...
                            <dd style="padding-left: 20px;">- Martillo de 7 puntas.</dd>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio25" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                      ...
                      <dl>
                          ...
                          <dd style="padding-left: 20px;">- Cinta antropométrica de fibra de vidrio.</dd>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio26" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio27" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio28" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                ...
                                <div role="tabpanel" class="tab-pane fade in" id="D">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio29" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio30" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio31" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio32" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio33" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio34" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio35" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio36" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio37" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio38" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio39" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio40" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio41" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio42" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check-inline">
                                                <label class="form-check-label">
                                                    <input type="radio" class="form-check-input" name="optradio43" />
                                                    2
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio44" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio45" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio46" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio47" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio48" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio49" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio50" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio51" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio52" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio53" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio54" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio55" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio56" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio57" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio58" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio59" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio60" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio61" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio62" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio63" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" name="optradio64" />
                                                            2
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphFooter" runat="Server">
    <script>
            function updateTextarea(element) {
                document.getElementById(element).innerText = document.getElementById("Visitado").value;
            }
        </script>
</asp:Content>
