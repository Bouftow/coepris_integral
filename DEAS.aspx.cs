        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                if (riesgo.Text == "1")
                {
                    ...
                    if (statos.Text == "14" || statos.Text == "22" || statos.Text == "23")
                    {

                        if (statos.Text == "14")
                        {

                            btnAprobado15.Visible = true;
                            btnAprobado15.Text = "Enviar a la DALS";
                            btnAprobado23.Visible = false;
                            btnAprobado24.Visible = false;
                        }

                        if (statos.Text == "22")
                        {

                            btnAprobado15.Visible = false;
                            btnAprobado23.Visible = true;
                            btnAprobado24.Visible = false;
                            if (tramite.RequiereVerificacion==false) { desaparecer.Visible = false; }
                        ...
                        if (statos.Text == "23")
                        {
                            ...
                            btnAprobado15.Visible = false;
                            btnAprobado23.Visible = false;
                            btnAprobado24.Visible = true;
                            if (tramite.RequiereVerificacion == false) { desaparecer.Visible = false; }
                            //btnAprobado15.Text = "Enviar a Firma";
                ...
                else
                {
                    ...
                    if (riesgo.Text == "2")
                    {
                        ...
                        if (statos.Text == "1003" || statos.Text == "1016" || statos.Text == "1018" || statos.Text == "1019")
                        {
                            if (statos.Text == "1003")
                            {
                                btnAprobado15.Visible = true;
                            ...
                            if (statos.Text == "1018")
                            {
                                ...
                                btnGuardar.Text = "Recibir desde DALS";
                            }
                            if (statos.Text == "1019")
                            {
                                btnAprobado15.Visible = true;
                ...
                if (riesgo.Text == "1")
                {
                    if (statos.Text == "14")
                    {
                        ...
                        if (chkVerificacion.Checked == true) { verifica.Visible = false; }
                        if (chkVerificacion.Checked == false) { sdivacta.Visible = false; sdict.Visible = false; grid2.Visible = false; }
                    }
                }
