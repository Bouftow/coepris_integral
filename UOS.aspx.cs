...
public partial class _default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                A1.HRef = tramite.iACTA.ToString(); if (A1.HRef != "") { A1.InnerText = Label1.InnerText.ToString(); } else { A1.Visible = false; }
                ...
                if (riesgo.Text == "1")
                {
                    if (statos.Text == "5" || statos.Text == "9" || statos.Text == "13")
                    {

                        btnAprobado6.Visible = true;

                    }

                    else
                    {
                        btnAprobado6.Visible = false;
                ...
                else
                {
                    if (riesgo.Text == "2")
                    {
                        ...
                        if (statos.Text == "1009" || statos.Text == "1015")
                        {
                            btnAprobado6.Text = "Enviar a la Coordinación";
                            btnAprobado6.Visible = true;
                        }
                        else
                        {
                    ...
                    else { btnAprobado6.Visible = false; }
                }
                ...
                if (riesgo.Text == "1")
                {
                    if (statos.Text == "5")
                    {
                        ...
                        if (chkVerificacion.Checked == false) { sino.InnerText = "No"; requiere.Visible = false; }
                    }
                }
                else { if (riesgo.Text == "2") { verifica.Visible = false; } }
    ...
    protected void btnAprobado_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (riesgo.Text == "1")
            {
                ...
                if (statos.Text == "5" || statos.Text == "11" || statos.Text == "9" || statos.Text == "13")
                {
                    a = 6;
            ...
            if (FileActa.HasFile)
            {
                ...
                string fileName = "ActaVerifUOS" + folio.Text + System.IO.Path.GetExtension(FileActa.FileName);
                iacta = "uploads/" + fileName + "";
                FileActa.SaveAs(Server.MapPath("~/") + iacta);
            }
    ...
    //{
    //    if (fuPuzzleImage.PostedFile != null)
    //    {
    //        try
    //        {
    ...
    //                {
    //                    string Hoy = DateTime.Now.ToString("dd-MM-yyyy H-mm-ss");
    //                    string Bitacorogo = "Bitacora";
    //                    hpf.SaveAs(Server.MapPath("~/uploads/") + System.IO.Path.GetFileName(Hoy + Bitacorogo) + System.IO.Path.GetExtension(hpf.FileName));
    ...
    protected void assss_Click(object sender, EventArgs e)
    {
         Response.Write("<script>;window.location ='Dctmatm/Av-atn-med-amb.aspx';</script>");
    }
}
