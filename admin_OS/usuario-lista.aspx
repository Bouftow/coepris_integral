    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div style="text-align: end">
                <a href="default.aspx" class="button_gray" style="color:#000"><i class="fa fa-chevron-left"></i>&nbsp;Regresar</a>
                <a class="button" style="color:#fff" href="usuario-item.aspx?id=<%=Server.UrlEncode("ti0i8u6Oh+l2RKo9llO2UQ==") %>"><i class="fa fa-plus"></i>&nbsp;Nuevo usuario</a>
            </div>       
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-sm-10">
                    <div class="form-group">
                        <asp:TextBox ID="txtTextoBuscar" placeholder="Login, nombre..." CssClass="form-control-sm" style="width:100%" runat="server"></asp:TextBox>
                    </div>
                </div>

                <div class="col-sm-2">
                    <asp:LinkButton ID="btnBuscar" OnClick="btnBuscar_Click" CssClass="button btn-block" Style="color:#fff" runat="server">Buscar&nbsp;<i class="fa fa-search"></i></asp:LinkButton>
                </div>
            ...
            <div class="card items">
                <asp:GridView ID="grdLista" HeaderStyle-CssClass="thead-inverse" CssClass="table table-hover " AutoGenerateColumns="false" CellSpacing="-1" GridLines="None" runat="server">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <%#String.Format("{0}",Eval("user_login").ToString()=="admin"?"":String.Format("<a href=\"usuario-item.aspx?id={0}\" class='button_gray btn-sm'><i class='fa fa-pencil'></i></a>",Server.UrlEncode(new EncryptDecrypt().Encrypt(Eval("user_login").ToString())))) %>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a href="#" class="button_gray btn-sm abrir-modal-pwd <%#String.Format("{0}",Eval("user_login").ToString()=="admin"?"hidden":"") %>" data-toggle="modal" data-id="<%#Eval("user_login") %>" data-target="#modal-pwd"><i class="fa fa-key"></i></a>
                            </ItemTemplate>
