<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="C12_alt.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Alt" role="tab" data-toggle="tab">Altamira</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Ald" role="tab" data-toggle="tab">Aldama</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Glz" role="tab" data-toggle="tab">González</a> </li>
                </ul>
            </div>

            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="Alt">
                        <h4><i>Altamira</i></h4>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Ald"> 
                        <h4><i>Aldama</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Glz">
                        <h4><i>González</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
