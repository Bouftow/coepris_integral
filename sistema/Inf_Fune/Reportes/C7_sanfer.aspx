<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="C7_sanfer.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Burg" role="tab" data-toggle="tab">Burgos</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Cru" role="tab" data-toggle="tab">Cruillas</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Men" role="tab" data-toggle="tab">Méndez</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Sanfer" role="tab" data-toggle="tab">San Fernando</a> </li>
                </ul>
            </div>

            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="Burg">
                        <h4><i>Burgos</i></h4>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Cru"> 
                        <h4><i>Cruillas</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Men">
                        <h4><i>Méndez</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Sanfer">
                        <h4><i>San Fernando</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                        <div class="row">
