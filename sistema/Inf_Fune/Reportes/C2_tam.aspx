<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="C2_tam.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Tam" role="tab" data-toggle="tab">Tampico</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Mad" role="tab" data-toggle="tab">Madero</a> </li>
                </ul>
            </div>

            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="Tam">
                        <h4><i>Tampico</i></h4>
                        <br />
