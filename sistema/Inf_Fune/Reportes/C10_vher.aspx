<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="C10_vher.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Vher" role="tab" data-toggle="tab">Valle Hermoso</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#RBvo" role="tab" data-toggle="tab">Río Bravo</a> </li>
                </ul>
            </div>

            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="Vher">
                        <h4><i>Valle Hermoso</i></h4>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="RBvo"> 
                        <h4><i>Río Bravo</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
