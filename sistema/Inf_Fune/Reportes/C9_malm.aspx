<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="C9_malm.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Gue" role="tab" data-toggle="tab">Guerrero</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Malm" role="tab" data-toggle="tab">Miguel Alemán</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Mier" role="tab" data-toggle="tab">Mier</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Cam" role="tab" data-toggle="tab">Camargo</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#GDO" role="tab" data-toggle="tab">Gustavo Díaz Ordaz</a> </li>
                </ul>
            </div>

            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="Gue">
                        <h4><i>Guerrero</i></h4>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Malm"> 
                        <h4><i>Miguel Alemán</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                        <div class="row">
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Mier">
                        <h4><i>Mier</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Cam">
                        <h4><i>Camargo</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="GDO">
                        <h4><i>Gustavo Díaz Ordaz</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                        <div class="row">
