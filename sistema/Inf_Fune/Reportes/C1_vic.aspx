<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="C1_vic.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Vic" role="tab" data-toggle="tab">Victoria</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Casas" role="tab" data-toggle="tab">Casas</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Guemez" role="tab" data-toggle="tab">Güemez</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Llera" role="tab" data-toggle="tab">Llera</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Hgo" role="tab" data-toggle="tab">Hidalgo</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Villagran" role="tab" data-toggle="tab">Villagrán</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Mainero" role="tab" data-toggle="tab">Mainero</a> </li>
                </ul>
            </div>

            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="Vic">
                        <h4><i>Victoria</i></h4>
                        <br />
