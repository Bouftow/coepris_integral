<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="C6_man.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#Man" role="tab" data-toggle="tab">Mante</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Nvo" role="tab" data-toggle="tab">Nuevo Morelos</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Ant" role="tab" data-toggle="tab">Antiguo Morelos</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Ocampo" role="tab" data-toggle="tab">Ocampo</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Xico" role="tab" data-toggle="tab">Xicoténcatl</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#GomFar" role="tab" data-toggle="tab">Gómez Farías</a> </li>
                </ul>
            </div>

            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="Man">
                        <h4><i>Mante</i></h4>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Nvo"> 
                        <h4><i>Nuevo Morelos</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                        <div class="row">
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Ant">
                        <h4><i>Antiguo Morelos</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                        <div class="row">
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Ocampo">
                        <h4><i>Ocampo</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Xico">
                        <h4><i>Xicoténcatl</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                        <div class="row">
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="GomFar">
                        <h4><i>Gómez Farías</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                        <div class="row">
