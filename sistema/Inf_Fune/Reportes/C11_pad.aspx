<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="C11_pad.aspx.cs" Inherits="_default" %>
        ...
        <div class="card sameheight-item" data-exclude="xs">
            <div class="card-header card-header-sm bordered">
                ...
                <ul class="nav nav-tabs pull-right" role="tablist">
                    <li class="nav-item"><a class="nav-link active" href="#SNic" role="tab" data-toggle="tab">San Nicolás</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#SCar" role="tab" data-toggle="tab">San Carlos</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Jim" role="tab" data-toggle="tab">Jiménez</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Abs" role="tab" data-toggle="tab">Abasolo</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#SLM" role="tab" data-toggle="tab">Soto la Marina</a> </li>
                    <li class="nav-item"><a class="nav-link" href="#Pad" role="tab" data-toggle="tab">Padilla</a> </li>
                </ul>
            </div>

            <div class="card-block">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active fade show" id="SNic">
                        <h4><i>San Nicolás</i></h4>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="SCar"> 
                        <h4><i>San Carlos</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                        <div class="row">
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Jim">
                        <h4><i>Jiménez</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Abs">
                        <h4><i>Abasolo</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="SLM">
                        <h4><i>Soto La Marina</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
                        <div class="row">
                    ...
                    <div role="tabpanel" class="tab-pane fade in" id="Pad">
                        <h4><i>Padilla</i></h4>
                        <br />
                        <p>Número de decesos por tipo de establecimiento:</p>
                        <br />
