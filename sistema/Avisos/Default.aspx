<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="sistema_Avisos_Captura" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMenus" runat="Server">
     <%=Usuarios.ShowMenu(User.Identity.Name,String.Format("avisos_captura.default.-1"),this.Page) %>
    <%=UsuariosOS.ShowMenu(User.Identity.Name,String.Format("avisos_captura.default.-1"),this.Page) %>
</asp:Content>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 offset-sm-1">
                                <div class="form-group">
                                    ...
                                    <asp:RadioButtonList OnLoad="RadioButtonList1_SelectedIndexChanged" ID="RadioButtonList1" AutoPostBack="true" RepeatDirection="Horizontal" runat="server">
                                         <asp:ListItem>&nbsp&nbsp&nbsp Física&nbsp&nbsp&nbsp</asp:ListItem>
                                         <asp:ListItem>&nbsp&nbsp&nbsp Moral&nbsp&nbsp&nbsp</asp:ListItem>
                                    </asp:RadioButtonList>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>Lada:</label>
                                    <asp:TextBox runat="server" ID="txt2LadaF" class="form-control"></asp:TextBox>
                                </div>
                                <div class="form-group">
                      ...
                      <%--  <label class="alert-dark text-center">Horario de operaciones</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <label>Teléfono:</label>
                                    <asp:TextBox runat="server" ID="txt3Tel" class="form-control"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label>Extensión:</label>
                                    <asp:TextBox runat="server" ID="txt3Ext" class="form-control"></asp:TextBox>
                                </div>
                        ...
                        <div class="form-group text-center">
                            ...
                            <button runat="server" class="boton-azo" onserverclick="btn_Grabar_Click" id="seguir3">Finalizar</button>
                        </div>
                    </div>
                </div>
            </div>
