...
/// </summary>
public class Avfunc_3Representantes
{
    public Avfunc_3Representantes()
    {
        //
    ...
    string curp3Representantes = "";
    string nombre3Representantes = "";
    string primerapellido3Representantes = "";
    string segundoapellido3Representantes = "";
    string lada3Representantes = "";
    string tel3Representantes = "";
    string ext3Representantes = "";
    string correo3Representantes = "";
    #endregion

    #region Propiedades

    public int FOLIO_REGISTRO_DETALLE_3Representantes { get { return FOLIO_REGISTRO_DETALLE; } set { FOLIO_REGISTRO_DETALLE = value; } }
    public int FOLIO_REGISTRO_3Representantes { get { return FOLIO_REGISTRO; } set { FOLIO_REGISTRO = value; } }
    public string Curp3Representantes { get { return curp3Representantes; } set { curp3Representantes = value; } }
    public string Nombre3Representantes { get { return nombre3Representantes; } set { nombre3Representantes = value; } }
    public string Primerapellido3Representantes { get { return primerapellido3Representantes; } set { primerapellido3Representantes = value; } }
    public string Segundoapellido3Representantes { get { return segundoapellido3Representantes; } set { segundoapellido3Representantes = value; } }
    public string Lada3Representantes { get { return lada3Representantes; } set { lada3Representantes = value; } }
    public string Tel3Representantes { get { return tel3Representantes; } set { tel3Representantes = value; } }
    public string Ext3Representantes { get { return ext3Representantes; } set { ext3Representantes = value; } } 
    public string Correo3Representantes { get { return correo3Representantes; } set { correo3Representantes = value; } }

    #endregion

    #region Metodos

    public DataTable CargarGrid_3Representantes(int id)
    {
        ...
        try
        {
            ...
            cmdCargarMascotas.CommandText = "bitaseg.[proc_RegistroCargarDetalle_3Representantes]";
    ...
    public bool Eliminar(int id)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "bitaseg.[proc_EliminarRegistroDetalle_3Representantes]";
    ...
    //{
        ...
        //    cmd.CommandType = CommandType.StoredProcedure;
        //    cmd.Connection = cnn;
        //    cmd.CommandText = "bitaseg.proc_GuardarRegistroDetalle_3representantes";
